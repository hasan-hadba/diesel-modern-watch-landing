...
## 📂 Project Structure
* `index.html`: The core structure including navigation and feature lists.
* `style.css`: All styling, including the custom `:root` color palette and animations.
* `main.js`: Animation sequences powered by the ScrollReveal library.
